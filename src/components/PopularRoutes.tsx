...
import cityPondicherry from "@/assets/city-pondicherry.jpg";
...
const routes = [
  {
    ...
    fromImg: cityChennai, toImg: cityBangalore,
    category: "Business",
    distance: "350 km", time: "5.5 hrs", price: "₹3,500",
  ...
  },
  {
    ...
    fromImg: cityChennai, toImg: cityPondicherry,
    category: "Scenic",
    distance: "170 km", time: "3 hrs", price: "₹1,800",
  ...
  },
  {
    ...
    fromImg: cityBangalore, toImg: cityMysore,
    category: "Scenic",
    distance: "150 km", time: "3 hrs", price: "₹1,600",
  ...
  },
  {
    ...
    fromImg: cityChennai, toImg: cityMadurai,
    category: "Religious",
    distance: "460 km", time: "7.5 hrs", price: "₹4,800",
  ...
  },
  {
    ...
    fromImg: cityBangalore, toImg: cityOoty,
    category: "Scenic",
    distance: "270 km", time: "5.5 hrs", price: "₹3,200",
  ...
  },
  {
    ...
    fromImg: cityChennai, toImg: cityCoimbatore,
    category: "Business",
    distance: "500 km", time: "8 hrs", price: "₹5,200",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {routes.map((route, i) => (
            <motion.div
              ...
              className="group bg-card rounded-xl border border-border overflow-hidden hover:shadow-xl hover:border-secondary/30 transition-all duration-300"
            >
              {/* Dual city images */}
              <div className="flex h-36 overflow-hidden">
                <div className="w-1/2 relative overflow-hidden">
                  <img src={route.fromImg} alt={route.from} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                  <span className="absolute bottom-2 left-3 text-xs font-heading font-bold text-primary-foreground">{route.from}</span>
                </div>
                <div className="w-1/2 relative overflow-hidden border-l-2 border-secondary">
                  <img src={route.toImg} alt={route.to} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                  <span className="absolute bottom-2 right-3 text-xs font-heading font-bold text-primary-foreground">{route.to}</span>
                </div>
              </div>
